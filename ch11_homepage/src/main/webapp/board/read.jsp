...
<head>
<meta charset="UTF-8">
<link href="../resources/css/style_normal.css" rel="stylesheet">
<title>상세보기</title>
</head>
<body>
	<table align="center">
		...
		<tr>
			<td colspan="4"><br>본문내용 :<br><%=board.getContent()%><br>
				<br> <br></td>
		</tr>
		<tr>
			<td colspan="4" align="right"><%=board.getIp()%>로 부터 글을 남기셨습니다 /
				조회수 : <%=board.getCount()%></td>
		</tr>
		<tr>
			<td colspan="4" align="center"><hr /> [ <a
				href="javascript:list()">리스트</a> | <a
				href="update.jsp?num=<%=num%>&nowPage=<%=nowPage%>">수 정</a> | <a
				href="reply.jsp?nowPage=<%=nowPage%>">답 변</a> | <a
				href="delete.jsp?num=<%=num%>&nowPage=<%=nowPage%>"> 삭 제</a> ]</td>
		</tr>
	</table>
