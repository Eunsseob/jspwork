...
<body>
	...
	<%
			String classRoom = (String)request.getAttribute("classRoom"); // Object로 넘어오기 때문
	...
	<p>
			...
			기본적으로 EL은 JSP내장객체를 구분하지 않고 자동으로 모든 내장객체에 키값을 검색하여 
	</p>
