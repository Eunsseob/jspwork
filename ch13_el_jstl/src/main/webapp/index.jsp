...
<body>
	...
	2. 지시어 : jsp 페이지 정보에 대한 내용을 표현하다거나 또 다른 페이지를 포함시킬 때 사용
					...
					ex) page 지시어, include 지시어, taglib지시어
	3. 액션태그(표준액션태그, 커스텀액션태그) : jsp페이지에서 어떤 동작을 하도록 지시하는 태그
																	xml 기술을 이용하여 기존의 jsp문법을 확장하는 기술
			>> 표준액션태그(Standard Action Tag) : jsp 페이지에서 바로 사용가능
																	모든 태그명 앞에 jsp : 접두어 붙임
			>> 커스텀액션태그(Custom Action Tag) : jsp페이지에서 바로 사용 불가(별도)
																	모든 태그명 앞에 jsp : 외의 다른 접두어 붙임
																	
	<h1>JSP Action Tag</h1>
	<p>xml 기술을 이용하여 기존의 jsp문법을 확장시키는 기술을 제공하는 태그들</p>
	<h3>* 커스텀 액션 태그</h3>
	<a href="views/2_customAction/jstl.jsp">JSTL</a>
	<a href="views/2_customAction/01.core.jsp">JSTL</a>
</body>
</html>