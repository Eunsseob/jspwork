...
<body>
	...
	* 부수적인속성
	...
	입력 : <input type="text" id="input1"><input type="button" id="btn1" value="전송">
	<br>
	...
	<script type="text/javascript">
		$("#btn1").click(function() {
			...
			$.ajax({
				...
				type : "get", // 생략가능 but, post는 반드시 작성
				...
				complete : function(){
					console.log("ajax통신 상관없이 출력");
				}
			})
		})
	</script>
	
<!-- 	<form action="idCheckFrm">
		ID : <input name="id" id="id" required>&nbsp;<input type="button" value="ID중복확인" id="idCheckBtn"><br>
	...
	<input type="button" id="btn2" value="전송"><br>
		...
		$("#btn4").click(function(){
			$.ajax({
				...
				success : function(result){
					...
					value += "<tr><th>" + result[i].id + "</th>" 
						+ "<th>" + result[i].name + "</th>"
						+ "<th>" + result[i].gender + "</th>"
						+ "<th>" + result[i].email + "</th></tr>";
					}	
